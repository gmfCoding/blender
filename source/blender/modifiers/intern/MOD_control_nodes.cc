...
void MOD_control_nodes_update_interface(Object *object, NodesModifierData *nmd)
{
  if (nmd->node_group == nullptr) {
...
{
  /* The property should be created in #MOD_control_nodes_update_interface with the correct type. */
  IDProperty *property = IDP_GetPropertyFromGroup(nmd->settings.properties, socket.identifier);
...
static void panel_draw(const bContext *C, Panel *panel)
{
  ...
  // Draw the New button (and more)
  uiTemplateID(layout,
               C,
               ptr,
               "node_group",
               "node.new_control_node_group_assign",
               nullptr,
               nullptr,
               0,
               false,
...
{
  PanelType *panel_type = modifier_panel_register(region_type, eModifierType_ControlNodes, panel_draw);
}
...
ModifierTypeInfo modifierType_ControlNodes = {
    /* name */ N_("ControlNodes"),
    /* structName */ "NodesModifierData",
    /* structSize */ sizeof(NodesModifierData),
    /* srna */ &RNA_ControlNodesModifier,
    // CHRIS_TODO: Do Control nodes need to be of type eModifierTypeType_Constructive 
    ...
    //nullptr, //* modifyMesh */ modifyMesh,
    //nullptr, //* modifyGeometrySet */ modifyGeometrySet,
    // CHRIS_TODO: Remove mesh modifcations
